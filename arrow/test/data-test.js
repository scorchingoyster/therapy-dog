...
describe('Data', () => {
  it('should not output undefined values, but still allow the data flag to propagate', () => {
  ...
  it('should evaluate raw helpers', () => {
    let arrow = new Arrow(`
  ...
  it('should propagate the data flag through cooked helpers', () => {
  ...
  it('should propagate the data flag through hash values of cooked helpers', () => {
  ...
  it('should propagate the data flag through chained inverse blocks', () => {
