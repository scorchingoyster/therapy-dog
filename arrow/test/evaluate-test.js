...
describe('Evaluate', () => {
  it('should evaluate a helper, calls, and literals', () => {
  ...
  it('should evaluate quoted strings', () => {
  ...
  it('should evaluate a helper with a hash', () => {
  ...
  it('should provide an empty body to a helper when the template specifies no body', () => {
  ...
  it('should evaluate a basic concat helper', () => {
  ...
  it('should evaluate inverse blocks, and be able to chain inverse blocks', () => {
  ...
  it("should put list items inside the nested instances of an arrow's target", () => {
  ...
  it("should put the nonempty source of an arrow inside its target", () => {
  ...
  it("should output nothing for an arrow with an empty source", () => {
    let arrow = new Arrow('x -> echo;');
    registerTestHelpers(arrow);
  ...
  it("should output only the nonempty elements of an arrow's array source", () => {
    let arrow = new Arrow('x -> echo;');
    registerTestHelpers(arrow);
  ...
  it("should just output the items of an arrow's source if it has no target", () => {
  ...
  it("should accept a helper as the source of an arrow", () => {
