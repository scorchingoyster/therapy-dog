...
let required = ['HOST', 'PORT', 'SWORD_BASE_URL', 'SWORD_USERNAME', 'SWORD_PASSWORD', 'FORMS_DIRECTORY', 'VOCABULARIES_DIRECTORY', 'UPLOADS_DIRECTORY', 'ADMIN_CONTACT_NAME', 'ADMIN_CONTACT_EMAIL'];
let optional = ['DEBUG'];
